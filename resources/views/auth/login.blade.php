...
<section>
    ...
    <div id="hero1"  class="w-full h-screen flex flex-col justify-center items-center">
        <img src="images/moni.svg" class="hover:scale-75 hidden lg:block w-1/2  transition-all duration-500 transform mx-auto"/>
    <form method="POST" action="{{ route('login') }}" class="flex flex-col justify-center items-center w-1/2">
        ...
        <h2 class="my-8 font-display font-bold text-3xl text-gray-700 text-center">Login to Your Account </h2>
        {{-- <label for="email" class="justify-items-start block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
            {{ __('E-Mail Address') }}:
        </label> --}}
        ...
        <div class="flex flex-wrap justify-center">
            <button type="submit"
            class="py-3 px-20 bg-indigo-500 focus:outline-none hover:bg-indigo-800 rounded-full text-white font-bold uppercase text-lg mt-4 transfrom hover:translate-y-1 transition-all duration-500">
                {{ __('Login') }}
            </button>
