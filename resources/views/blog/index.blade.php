...
<section class="bg-white p-6">
  <div class=" grid grid-cols-1 m-auto">
    <div class="flex text-black pt-1">
        <div class="m-auto pt-8 pb-16 sm:m-auto w-4/5 block text-center space-y-10">
            <h1 id="hero-caption" class="text-gray-600 mt-12 text-6xl uppercase font-bold text-shadow-md pb-3  font-mono">
                <span class="text-pink-400">W</span>ild<span class="text-purple-400">S</span>ki<span class="text-gray-400">n</span>
            </h1>
   ...
   @endif
     @if (Auth::check())
       <div class="pt-15 w-4/5 m-auto animate-bounce">
         <a href="/blog/create" class="bg-blue-500 uppercase px-5 bg-transparent text-gray-100 text-xs font-extrabold py-3 rounded-3xl">Create Post <i class="fas fa-pen fa-2x"></i></a>
       </div>
     @endif
    {{-- Carousel section  --}}
